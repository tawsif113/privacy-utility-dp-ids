...
| 05 | `05_dp_sgd_privacy_utility_sweep.ipynb` | Implementation ready; execution evidence and acceptance are pending |
| 06 | `06_repeated_runs_stability.ipynb` | Planned; not created |
